...
CARE = {
"ALO":[("sun","אור בהיר ועקיף, ללא שמש ישירה"),("drop","לחות גבוהה, 60% ומעלה"),("leaf","מצע קליל ומאוורר עם ניקוז מעולה"),("therm","השקיה מדודה, להמתין לייבוש קל"),("spray","רגיש לריקבון שורשים"),("pot","נכנסת לתרדמה בחורף, נשירת עלים טבעית")],
...
"PHIL":[("sun","אור בהיר ועקיף"),("drop","לחות בינונית עד גבוהה"),("leaf","מצע מאוורר עשיר בחומר אורגני"),("therm","השקיה כשהשכבה העליונה מתייבשת"),("climb","מטפס, אוהב מוט תמיכה"),("pot","צמיחה נמרצת בעונה החמה")],
"BEG":[("sun","אור בהיר ועקיף, ללא שמש ישירה"),("drop","לחות בינונית עד גבוהה"),("leaf","מצע קליל ומנוקז היטב"),("therm","השקיה כשהשכבה העליונה מתייבשת"),("spray","להימנע מהרטבת עלים, רגישה לעובש"),("pot","גבעולי קנה, אוהבת תמיכה קלה")],
"FERN":[("sun","אור בהיר ועקיף, ללא שמש ישירה"),("drop","לחות גבוהה, אוהב אוויר לח"),("leaf","גדל על ספגנום מוס, בלי אדמה"),("therm","הרטבה כשהספגנום מתייבש"),("spray","אפשר לרסס עלים בימים יבשים"),("pot","אפיפיט, נאחז על לוח עץ או שורש")],
}
