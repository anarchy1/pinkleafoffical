# Cup label print list

Master list of labels to print for the cups. Grouped by genus, alphabetical
inside each group. QTY = how many labels of that variety to print. Add to this
as we go so nothing has to be re-listed.
