#!/usr/bin/env python3
"""Wire the 2026-09-14 encyclopedia entries into entries.json, standalone pages, footer links and sitemap.
Run from the repo root. Idempotent: skips slugs that already exist."""
import json, re, html, datetime, os

new = json.load(open('content/new-entries-2026-09-14.json', encoding='utf8'))
...
short = {'fertilizing-rare-aroids': 'Fertilizing Aroids',
         'pests-thrips-mites-quarantine': 'Pests &amp; Quarantine',
         'alocasia-corm-propagation': 'Alocasia Corms'}
